...
const data = [
    {
        ...
        description: "Seamlessly reach your learning goals with our user-friendly platform, ensuring effortless navigation and immediate access to enriching educational content.",
        icon: /*#__PURE__*/ jsx_runtime_.jsx((ArtTrack_default()), {})
    },
    {
        title: "More Affordable Cost",
        description: "Unlock your learning potential without breaking the bank. Benefit from budget-friendly options tailored to your educational journey.",
        icon: /*#__PURE__*/ jsx_runtime_.jsx((AttachMoney_default()), {})
    },
    {
        title: "Flexible Study Time",
        description: "Tailor your learning to fit your schedule. Enjoy the freedom to study whenever and wherever it suits you best.",
        icon: /*#__PURE__*/ jsx_runtime_.jsx((LocalLibrary_default()), {})
    },
    {
        title: "Consultation With Mentor",
        description: "Gain personalized guidance from experienced mentors. Elevate your learning journey with one-on-one support and valuable insights.",
